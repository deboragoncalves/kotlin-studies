...
fun main(args: Array<String>) {
   ...
   var classification : String = classificationImc(calcImc(weight, height))
   println(classification)
}

fun calcImc(anyWeight : Double, anyHeight: Double) : Double {
   var resultImc : Double = anyWeight / Math.pow(anyHeight, 2.0)
   return resultImc
}

fun classificationImc(imc : Double) : String {
